...
# PEV power demand into four time zones) and converts it back into the original 
...
# =============================================================================
TZ <- read.csv2("TimeZones.csv", stringsAsFactors = FALSE) # Path to CSV file
...
# =============================================================================
write.csv2(PEV_L1, "PEV_L1-01.csv", row.names = FALSE) # Path to export PEV_L1 file
write.csv2(PEV_L2, "PEV_L2-01.csv", row.names = FALSE) # Path to export PEV_L2 file
